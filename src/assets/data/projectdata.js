...
const projectData = [{
        id: uuidv4(),
        name: 'PySolSweep',
        desc: 'PySolSweep is a Static Program Analysis tool, which evaluates the securiity safety of a Solidity based Smart Contract. This tool offers coverage accross three classes of attacks from Overflow/Underflow, Syntax and DAO. This benefits of PySolSweep is its ability to overcome existing Solidity Static Analysis tools limitations of a systematic approach of Bug Attack Theme coverage of bugs rather than a randmom assortment, suggested solution to overcome bug, vulnrability or countermeasure. The tool also provides a log report of the Static Analysis results.',
        img: Sol,
        link: 'https://github.com/nikhilsurfingaus/ThesisProject',
    },
    {
        id: uuidv4(),
        name: 'NFT Collection',
        desc: 'An NFT collection is an assortment of digital assets released by an artist (or group of artists) containing a limited number of individual NFTs. Own a peice of surfing history from men and women that have competed or shaped the world of surfing. Quiver calls all ocean lovers and wave chargers to own pieces of surfing history with NFT surfboards ridden by current and past legends of proffessional surfing. Own your own digital NFT collection of surfboards. Collect them all to build your surfboard Quiver to begin your ride into the NFT digital asset trend.',
        img: Nft,
        link: 'https://mintable.app/u/nikhilsurfingaus',
    },
    {
        id: uuidv4(),
        name: 'FlyInOz',
        desc: 'FlyInOz is a web application built to connect Australian domestic travellers and aviation enthusieasts to the airlines, aircraft and airports of Australia. Providing Aussies a guide to Airline Operators and Airports, through a collated exposition of booking links and navigation information for airports. Adding to the aviation hub expereience we also offer your you as domestic travllers the opporunity to post your flight reviews in out un-filtered reviews hub. The FlyInOz web app provides domestic Australian travellers can make more informed travel choices.',
        img: Fly,
        link: 'https://flyinoz.netlify.app/',
    },
    {
        id: uuidv4(),
        name: 'QIVC Crypto Trading',
        desc: 'Quiver Coin (QIVC) is a peer-to-peer (P2P) virtual currency, which means it is not governed by a central authority. Quiver Coins network offers instant, near-zero cost payments that can be conducted by individuals or institutions across the globe. The conesnsus implemented by Quiver Coin is Proof Of Stake (PoS), meaning blockchains algorithmically are chosen to verify transactions with computer hardware based on the tokens they have staked/locked, in the network as collateral. You can trade QIVC/BUSD currently on the Binance exchange.',
        img: CPT,
        link: 'https://www.binance.com/en/trade/QUICK_BUSD?theme=dark&type=spot',
    },
    {
        id: uuidv4(),
        ...
        img: ETH,
        link: 'https://github.com/nikhilsurfingaus/QuiverNFTWebApp',
    },
    {
        id: uuidv4(),
        ...
        img: TAG,
        link: 'https://github.com/nikhilsurfingaus/CounterTerrorismTAGResponseTime',
    },
    {
        id: uuidv4(),
        name: 'F1 2021 Season Hub',
        desc: 'The Formula 1 season that occured in the year 2021 was one to remeber for the ages, and could quite possibly go down as the greatest. With multiple world champion Lewis Hamilton at Mercedes taking on the young Dutchman Max Verstappen and the RedBull outfit. The F1 2021 Season Hub webpage takes F1 Fans through a tour of the season, race-by-race summary, driver reviews, season stats and a quiz. Also on show is a timeline section called the Champions Cornero f Max Verstappens path to glory of the 2021 Formula 1 drivers championship. ',
        img: MAX,
